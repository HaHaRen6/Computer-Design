...
#
# Generated by Vivado on Wed Jul 19 15:37:31 +0800 2023
...
# Script info
echo -e "IROM.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot IROM xil_defaultlib.IROM xil_defaultlib.glbl -log elaborate.log
}
